...
module.exports = function () {
  this.transpond = function (req, res) {
    ...
    var configFullPath = path.resolve("config/transpond-config.js");
    ...
    if (transCurrent.attachHeaders) {
      var j;
      for (j in transCurrent.attachHeaders) {
        options.headers[j] = transCurrent.attachHeaders[j];
      }
    }
